...
<div class="elematic-post-grid-item elematic-img-zoom elematic-post-grid-<?php echo esc_attr( $settings['grid_style'] ); ?>">
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <div class="elematic-post-grid-style-4-wrapper">
            <?php if (has_post_thumbnail()) : ?>
                <div class="elematic-post-thumb elematic-post-thumb-left">
                    <a href="<?php echo esc_url(get_permalink()); ?>" title="<?php the_title_attribute(); ?>">
                        <?php the_post_thumbnail($settings['image_size']); ?>
                    </a>
                </div>
            <?php endif; ?>
            <div class="elematic-post-content elematic-post-content-right">
                ...
                <?php endif; ?>
                <?php if ('show' === $settings['date'] || 'show' === $settings['author'] || 'show' === $settings['comments'] || 'show' === $post_category) : ?>
        ...
        </div><!-- .elematic-post-grid-style-4-wrapper -->
    </article>
</div><!-- style 4 -->